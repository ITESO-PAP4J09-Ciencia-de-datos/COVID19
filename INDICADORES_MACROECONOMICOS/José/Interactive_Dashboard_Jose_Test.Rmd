...
Visitantes <- Visitantes %>% 
 ...
 unique(Visitantes$Nacionalidad)
...
Visitantes4 <- Visitantes1 %>%
  model(arima=ARIMA(Entradas),ets=ETS(Entradas),snaive=SNAIVE(Entradas~lag(Periodo))) %>%
  forecast(h=5)
